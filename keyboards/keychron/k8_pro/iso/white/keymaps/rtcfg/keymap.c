...
// EXPERIMENTAL: runtime-config (rtcfg) keymap using the shared
// keychron/rtcfg_common core. Layout copied from this variant's via keymap;
// verified to COMPILE only — NOT tested on hardware.
...
// Combo table QMK's introspection serves; the rtcfg core fills it at runtime.
...
[MAC_FN] = LAYOUT_tkl_iso(
     ...
     BL_TOGG,  BL_STEP,  BL_UP,    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,            KC_TRNS,  KC_TRNS,  KC_TRNS,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    return rtcfg_process_record(keycode, record);
}
